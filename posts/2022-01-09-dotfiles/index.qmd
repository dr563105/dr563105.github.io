---
image: gnu-logo.png #The_GNU_logo.png
...
::: {.callout-important}
Pay attention to personal information inside these
...
and using [*yadm*](https://yadm.io/). However, I found those harder to get started.
