---
title: "AWS Lambda with API Gateway - Part 2"
description: "A post on using API Gateway with AWS Lambda with ECR image as source."
date: "2023-06-04"
...
format: 
  html: 
    ...
    code-overflow: wrap
image: api-lambda-ecr-sns-db2-logo.png
---
...
export HISTIGNORE= \
        "ls*:cat*:*AWS*:*SECRET*:*KEY*:*PASS*:*TOKEN*" # <1>
 export AWS_ACCESS_KEY_ID=xxxx
 export AWS_SECRET_ACCESS_KEY=xxxtt
```
1. History doesn't store any command that has leading space. Highly useful for sensitive environment variables.
