...
## Testing
Testing the data pipeline is one of the important aspects of data engineering. I'm on the process of writing a new blog on it. I will link it as soon it is ready. 

Meanwhile, you can do unit tests on datagen and source DB and integration test on datagen-sourceDB.

:::{.callout-note}
More unit and integration tests on Debezium and Kafka are WIP.
:::
