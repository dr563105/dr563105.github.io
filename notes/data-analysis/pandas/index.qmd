...
df['Rank'] = df['Value'].rank() # <5>

df['Percentage Change'] = df['Value'].pct_change() # <6>

weekly_rolling_mean = df['data'].resample('W').mean().rolling(window=3).mean() # <7>
...
There is also method chaining. To know more on that and others Pandas concepts, refer to my [other notes](https://deepakramani.github.io/notes/py_for_finance.html).